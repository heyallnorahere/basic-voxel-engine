...
namespace BasicVoxelEngine
{
    public sealed class Buffer
    {
        ...
        public void Copy(Buffer buffer, int offset = 0) => CopyBuffer_Native(mAddress, buffer.mAddress, offset);
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        private static extern void CopyBuffer_Native(IntPtr address, IntPtr buffer, int offset);
        [MethodImpl(MethodImplOptions.InternalCall)]
