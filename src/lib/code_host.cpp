...
namespace bve {
    ...
    std::unordered_map<std::string, void*> code_host::get_script_wrappers() {
        ...
        return {
            ...
            pair("BasicVoxelEngine.Graphics.Shader::GetReflectionData_Native", BasicVoxelEngine_Graphics_Shader_GetReflectionData),
            ...
            pair("BasicVoxelEngine.Graphics.ComputePipeline::DestroyRef_Native", BasicVoxelEngine_Graphics_ComputePipeline_DestroyRef),
            pair("BasicVoxelEngine.Graphics.ComputePipeline::BindUniformBuffer_Native", BasicVoxelEngine_Graphics_ComputePipeline_BindUniformBuffer),
            pair("BasicVoxelEngine.Graphics.ComputePipeline::BindStorageBuffer_Native", BasicVoxelEngine_Graphics_ComputePipeline_BindStorageBuffer),
            pair("BasicVoxelEngine.Graphics.ComputePipeline::Dispatch_Native", BasicVoxelEngine_Graphics_ComputePipeline_Dispatch),

            pair("BasicVoxelEngine.Graphics.ShaderReflectionField::GetOffset", BasicVoxelEngine_Graphics_ShaderReflectionField_GetOffset),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionField::GetType", BasicVoxelEngine_Graphics_ShaderReflectionField_GetType),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetName", BasicVoxelEngine_Graphics_ShaderReflectionType_GetName),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetSize", BasicVoxelEngine_Graphics_ShaderReflectionType_GetSize),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetArrayStride", BasicVoxelEngine_Graphics_ShaderReflectionType_GetArrayStride),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetArraySize", BasicVoxelEngine_Graphics_ShaderReflectionType_GetArraySize),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetFieldNames", BasicVoxelEngine_Graphics_ShaderReflectionType_GetFieldNames),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::GetField", BasicVoxelEngine_Graphics_ShaderReflectionType_GetField),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::FindOffset_", BasicVoxelEngine_Graphics_ShaderReflectionType_FindOffset),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::CreateRef", BasicVoxelEngine_Graphics_ShaderReflectionType_CreateRef),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionType::DestroyRef", BasicVoxelEngine_Graphics_ShaderReflectionType_DestroyRef),
            pair("BasicVoxelEngine.Graphics.ShaderResourceData::GetName", BasicVoxelEngine_Graphics_ShaderResourceData_GetName),
            pair("BasicVoxelEngine.Graphics.ShaderResourceData::GetType", BasicVoxelEngine_Graphics_ShaderResourceData_GetType),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetUniformBufferIndices", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetUniformBufferIndices),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetUniformBufferData", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetUniformBufferData),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetSampledImageIndices", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetSampledImageIndices),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetSampledImage", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetSampledImage),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetStorageBufferIndices", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetStorageBufferIndices),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetStorageBufferData", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetStorageBufferData),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetPushConstantBufferIndices", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetPushConstantBufferIndices),
            pair("BasicVoxelEngine.Graphics.ShaderDescriptorSetData::GetPushConstantBufferData", BasicVoxelEngine_Graphics_ShaderDescriptorSetData_GetPushConstantBufferData),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionData::GetDescriptorSetIndices", BasicVoxelEngine_Graphics_ShaderReflectionData_GetDescriptorSetIndices),
            pair("BasicVoxelEngine.Graphics.ShaderReflectionData::GetDescriptorSetData", BasicVoxelEngine_Graphics_ShaderReflectionData_GetDescriptorSetData),
        };
    }
